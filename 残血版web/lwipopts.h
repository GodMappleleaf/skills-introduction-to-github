...
#define LWIP_HTTPD_MAX_REQUEST_URI_LEN 127
#define LWIP_HTTPD_POST_MAX_RESPONSE_URI_LEN 127
//#define LWIP_HTTPD_SSI_RAW 1
#define LWIP_HTTPD_FILE_STATE 1
//#define LWIP_HTTPD_CUSTOM_FILES 1
//#define HTTPD_PRECALCULATED_CHECKSUM 1  // 启用预校验
//#define LWIP_CHECKSUM_ON_COPY        1  // 配合使用，必须开启
/* USER CODE END 1 */
